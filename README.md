...
Edit [src/main/webapp/content/scss/vendor.scss](src/main/webapp/content/scss/vendors/_vendor.scss) file:
...
To build the final jar and optimize the stch_frontend application for production, run:
